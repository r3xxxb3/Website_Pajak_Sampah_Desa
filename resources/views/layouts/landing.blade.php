    ...
    <div class="header-4-2 container-xxl mx-auto p-0 position-relative" style="font-family: 'Poppins', sans-serif">
      <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content bg-white border-0">
              ...
              <div class="modal-footer border-0 gap-3" style="padding: 2rem; padding-top: 0.75rem">
                <a class="btn btn-default btn-no-fill" href="{{ route('login-page') }}" >Log In</a>
                <a class="btn btn-fill text-white" href="{{ route('register-page') }}" >Register</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo">
          ...
          <div class="gap-3">
              @if(auth()->guard('web')->check())
              <a class="btn btn-default btn-no-fill" href="{{ route('logout') }}">Log Out</a>
              @else
                <a class="btn btn-default btn-no-fill" href="{{ route('login-page') }}">Log In</a>
                <a class="btn btn-fill text-white" href="{{ route('register-page') }}">Register</a>
              @endif
