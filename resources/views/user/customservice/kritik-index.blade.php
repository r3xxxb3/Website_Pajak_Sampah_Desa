                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning text-white col mb-2" data-toggle="modal" data-target="#modal-edit" onclick="update({{$k}})"><i class="fas fa-pencil-alt"></i> Ubah</a>
                                                <a class="btn btn-danger text-white col mb-2" href="{{route('custom-kritik-delete', $k->id)}}" onclick="return confirm('Anda yakin akan menghapus data ?')"><i class="fas fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('custom-kritik-store')}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="desa" class="font-weight-bold text-primary">Desa Adat</label>
                            ...
                            <div class="row mt-5">
                                <div class="col" style="vertical-align: middle; text-align: right;">
                                    ...
                                    <a class="btn btn-danger text-white" data-toggle="modal" data-target="#modal-add"><i class="fas fa-times"></i> Batal</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-body">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-primary">Ubah Kritik & Saran</h5>
                    </div>
                    <hr>
                    <div class="card-body">
                        <form action="{{route('custom-kritik-update')}}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div id="myDIV" style="display: block">
                                <div class="row justify-content-between mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="udesa" class="font-weight-bold text-primary">Desa Adat</label>
                                    <select class="form-control" name="udesa" id="udesa">
                                        @foreach($desa as $d)    
                                            <option value="{{$d->id}}">{{$d->desadat_nama}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col">
                                    <label for="usubjek" class="font-weight-bold text-primary">Jenis Subjek</label>
                                    <select class="form-control" name="usubjek" id="usubjek">
                                        <option value="pelayanan">Pelayanan</option>
                                        <option value="website">Website</option>
                                        <option value="jadwal pengangkutan">Jadwal Pengangkutan</option>
                                        <option value="jenis jasa & retribusi">Jenis Jasa & Retribusi</option>
                            ...
                            <div class="row" style="height:150px;">
                                <div class="col" >
                                    <label for="ucomment" class="font-weight-bold text-primary">Kritik & Saran</label>
                                    <textarea class="form-control" name="ucomment" id="ucomment" style="height:100%; background-color:light;" placeholder="Masukan kritik & saran anda !">
                            ...
                            <div class="row mt-5">
                                <div class="col" style="vertical-align: middle; text-align: right;">
                                    ...
                                    <a class="btn btn-danger text-white" data-toggle="modal" data-target="#modal-edit"><i class="fas fa-times"></i> Batal</a>
                                </div>
                            </div>
                        </form>
                    </div>
