                        ...
                        <div class="col-2">
                            ...
                            <select class="form-control" name="desaAdat" id="desaAdat">
                                ...
                                @foreach($desaAdat as $d)
                                    <option value="{{$d->id}}" {{isset(auth()->guard('web')->user()->kependudukan->mipil->banjarAdat->desaAdat) ? ($d->id == auth()->guard('web')->user()->kependudukan->mipil->banjarAdat->desaAdat->id ? 'selected' : '') : ''}}>{{$d->desadat_nama}}</option>
                                @endforeach
                            </select>                            
                            @error('desaAdat')
                            <span class="invalid-feedback" role="alert">
