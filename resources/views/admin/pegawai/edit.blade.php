            ...
            <div class="form-group card-body">    
                <div class="row">
                    ...
                    <div class="col mb-2">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror disabled" id="role" name="role" placeholder="Masukan Role Pegawai" value="{{$pegawai->role->map->role}}">
                            @error('role')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>    
