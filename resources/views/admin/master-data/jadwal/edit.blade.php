                ...
                <div class="form-group card-body">    
                    <div class="row">
                        <div class='col mb-2'>
                            ...
                            <input type="time" class="form-control" id="mulai" name="mulai" placeholder="Masukan waktu mulai (Standar waktu 24 Jam)" value="{{$jadwal->mulai}}">
                        ...
                        <div class="col mb-2">
                            ...
                            <input type="time" class="form-control" id="selesai" name="selesai" placeholder="Masukan Waktu Selesai (Standar Waktu 24 jam)" value="{{$jadwal->selesai}}">
                            <small style="color: red">
                                @error('selesai')
                                    {{$message}}
                                @enderror
