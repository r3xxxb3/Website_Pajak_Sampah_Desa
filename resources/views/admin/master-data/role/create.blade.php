...
<section class="section">
    ...
    <div class="section-body">
        <div class="container-fluid">
            ...
            @endif
            <form method="POST" enctype="multipart/form-data" action="{{route('masterdata-role-store')}}">
            @csrf
                ...
                <div class="form-group card-body">    
                    <div class="row mb-2">
                        <div class='col col-3 mb-2'>
                            ...
                            <input type="text" class="form-control @error('role') is-invalid @enderror" id="role" name="role" placeholder="Masukan Jenis Role">
                                @error('role')
